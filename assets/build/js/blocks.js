...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)('aquila-blocks/heading', {
   ...
   * @type {string}
   */
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Heading and select Icons', 'aquila'),
  /**
   * Block category.
   *
   * @type {string}
  ...
  save: function save() {
    return /*#__PURE__*/React.createElement("div", null, "Hello world, step 1 (from the frontend)");
  }
});
